...
namespace _Common
{
    ...
    public class SimpleDataSet
    {
        ...
        { return Methods.SerializeObject_Json(typeof(SimpleDataSet), this); }
        ...
        { return (SimpleDataSet)Methods.DeserializeObject_Json(typeof(SimpleDataSet), SerializeData); }
    ...
    public class SimpleDataTable
    {
		...
		/// <returns></returns>
        public string Serialize()
        { return Methods.SerializeObject_Json(typeof(SimpleDataTable), this); }
        ...
        { return (SimpleDataTable)Methods.DeserializeObject_Json(typeof(SimpleDataTable), SerializedData); }
        ...
        public DataTable ToDataTable()
        {
            ...
            foreach (SimpleDataRow Sdr in this.mList_DataRow)
            {
                ...
                Dt.Rows.Add(Dr_New);
                foreach (SimpleDataColumn Sdc in this.mList_DataColumn)
                { Dr_New[Sdc.ColumnName] = Methods.IsNull(Sdr[Sdc.ColumnName], DBNull.Value); }
            }
    ...
    public class SimpleDataRow
    {
        ...
        public string Serialize()
        {
            return Methods.SerializeObject_Json(typeof(SimpleDataRow), this);
        }

        public static SimpleDataRow Deserialize(String SerializedData)
        { return (SimpleDataRow)Methods.DeserializeObject_Json(typeof(SimpleDataRow), SerializedData); }
        ...
        public DataRow ToDataRow()
        {
            ...
            { Dr[Item.DataColumn.ColumnName] = Methods.IsNull(Item.Value, DBNull.Value); }
